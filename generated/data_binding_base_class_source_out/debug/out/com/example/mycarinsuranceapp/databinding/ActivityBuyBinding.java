...
public final class ActivityBuyBinding implements ViewBinding {
  ...
  private ActivityBuyBinding(@NonNull ConstraintLayout rootView, @NonNull Button button5,
      @NonNull Button button6, @NonNull ConstraintLayout main) {
  ...
  public static ActivityBuyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBuyBinding((ConstraintLayout) rootView, button5, button6, main);
    }
